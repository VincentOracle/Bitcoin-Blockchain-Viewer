...
class BitcoinViewer:
    ...
    def connect_to_node(self):
        # For testing purposes, display a dummy block
        self.display_dummy_block()
    ...
    def display_dummy_block(self):
        dummy_block = {
            'version': 536870912,
            'prev_block': b'\x1630' * 12,
            'merkle_root': b'\x5043' * 11,
            'timestamp': int(time.time()),
            'bits': 0x1d00ffff,
            'nonce': 2083236893,
            'tx_count': 10
        }
        self.display_block(dummy_block)
